...
d,g){a.fn.foundation?d||(d=a('<div class="reveal-overlay" style="display:block"/>'),a('<div class="reveal reveal-modal" style="display:block; top: 150px;" data-reveal/>').append('<button class="close-button" aria-label="Close">&#215;</button>').append(e&&e.header?"<h4 class="text-muted">"+e.header(f)+"</h4>":null).append(g()).appendTo(d),d.appendTo("body"),a("button.close-button").on("click",function(){a(".reveal-overlay").remove()}),a(".reveal-overlay").on("click",function(){a(".reveal-overlay").remove()})):h(f,d,
