...
func ExternalMessage_GetList() (int, []dm.ExternalMessage, error) {
	...
	tsql := "SELECT * FROM " + get_TableName(core.GetSQLSchema(core.ApplicationPropertiesDB), dm.ExternalMessage_SQLTable)
...
//Deal with the if its Application or null add this bit, otherwise dont.
	...
	tsql := "INSERT INTO " + get_TableName(core.GetSQLSchema(core.ApplicationPropertiesDB), dm.ExternalMessage_SQLTable)
	tsql = tsql + " (" + fields(ts) + ")"
