...
func init() {
	EstimationSessionAction_SQLbase = core.DB_SELECT + " " + core.DB_ALL + " " + core.DB_FROM + " " + get_TableName(core.GetSQLSchema(core.ApplicationPropertiesDB), dm.EstimationSessionAction_SQLTable)
}
