...
func CredentialsPassword_Store(r dm.CredentialsPassword, req *http.Request) (dm.CredentialsPassword, error) {
	logs.Information("CredentialsPassword_Store()", fmt.Sprintf("ID=%s", r.ID))
	logs.Information("CredentialsPassword_Store()", fmt.Sprintf("UserName=%s", r.UserName))
	logs.Accessing("CredentialsPassword_Validate-STORE")
	r, err := CredentialsPassword_Validate(r)
	//logs.Warning("CredentialsPassword_Store()-Validate Error=" + err.Error())
	if err == nil {
...
func CredentialsPassword_StoreSystem(r dm.CredentialsPassword) (dm.CredentialsPassword, error) {
	logs.Information("CredentialsPassword_StoreSystem()", fmt.Sprintf("ID=%s", r.ID))
	logs.Accessing("CredentialsPassword_Validate-SYSTEM")
	r, err := CredentialsPassword_Validate(r)
	logs.Warning("CredentialsPassword_StoreSYSTEM()-Validate Error=" + err.Error())
	if err == nil {
...
func CredentialsPassword_Validate(r dm.CredentialsPassword) (dm.CredentialsPassword, error) {
	...
	//
	fmt.Printf("err: %v\n", err)
	fmt.Println("CredentialsPassword_Validate()-EXITING")
	fmt.Printf("r: %v\n", r)
	//logs.Information("ErrState=", err.Error())
	//fmt.Printf("SAUSAGE: %v", err.Error())
	if err == nil {
		fmt.Println("CredentialsPassword_Validate()-err==nil")
		return r, nil
	}
	fmt.Printf("SAUSAGE: %v", err.Error())
...
func credentialspassword_Save(r dm.CredentialsPassword, usr string) error {
	logs.Saving("CredentialsPassword", fmt.Sprintf("%v", r))
	logs.Saving("CredentialsPassword", fmt.Sprintf("%v", usr))
	var err error
