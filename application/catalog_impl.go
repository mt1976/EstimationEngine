...
func Catalog_Publish_impl(mux http.ServeMux) {
	// START
	// Auto generated 08/12/2022 by matttownsend (Matt Townsend) on silicon.local
	//
	mux.HandleFunc(dm.Catalog_Path, Catalog_Handler_impl)
	mux.HandleFunc(dm.Catalog_PathList, Catalog_HandlerList_impl)
	mux.HandleFunc(dm.Catalog_PathView, Catalog_HandlerView_impl)
	//Cannot Edit via GUI
...
func Catalog_HandlerList_impl(w http.ResponseWriter, r *http.Request) {
	// START
	// Auto generated 08/12/2022 by matttownsend (Matt Townsend) on silicon.local
	//
	...
	noItems, returnList, _ := dao.Catalog_GetList_impl()
...
func Catalog_HandlerView_impl(w http.ResponseWriter, r *http.Request) {
	// START
	// Auto generated 08/12/2022 by matttownsend (Matt Townsend) on silicon.local
	//
	// Mandatory Security Validation
	...
	_, rD, _ := dao.Catalog_GetByID_impl(searchID)
...
func catalog_PopulatePage_impl(rD dm.Catalog, pageDetail dm.Catalog_Page) dm.Catalog_Page {
	// START
	// Auto generated 08/12/2022 by matttownsend (Matt Townsend) on silicon.local
	//
	pageDetail.ID = rD.ID
